    ...
    <React.Fragment>
      {videoSent ?
        <div onClick={() => setVideoSent(false)}>
          <p className={classes.submitMessage} >Video Submitted! You'll recieve comprehensive feedback to your email in the next 24 hours! You can submit 1 question a day (unless it's your first time you can do 2 today only!)</p>
        </div>
        : null}
